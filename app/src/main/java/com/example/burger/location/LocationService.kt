...
class LocationService: android.app.Service(){
    ...
    private fun start(){
        val notification = NotificationCompat.Builder(this, "Local")
            .setContentTitle("Tracking location...")
            .setContentText("Location null")
            .setContentText(R.id.tvLocationName.toString())

        val notificationMenager = getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager

        locationClient
            .getlcationUpdates(10000L)
            ...
            .onEach { location ->
                ...
                notificationMenager.notify(1, updateNotification.build())
            }
